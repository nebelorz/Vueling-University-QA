using MariaLunarillos.Auto.Test.Data;

namespace MariaLunarillos.Auto.SetUp {

    public class ObjectsTest {
        private LoadScenarioTestCasesConfiguration loadScenarioTestCasesConfiguration = new LoadScenarioTestCasesConfiguration();
